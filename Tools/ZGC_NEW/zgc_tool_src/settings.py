class Settings:
    ...
    def __init__(self):
        ...
        self.hci_command_list = {
            ...
            0x4001: 'ZBHCI_CMD_BDB_GET_LINK_KEY_REQ',
            0x4002: 'ZBHCI_CMD_BDB_SET_LINK_KEY_REQ',
            0x4003: 'ZBHCI_CMD_BDB_GET_MAC_ADDR_REQ',
            0xC001: 'ZBHCI_CMD_BDB_GET_LINK_KEY_RSP',
            0xC003: 'ZBHCI_CMD_BDB_GET_MAC_ADDR_RSP',
	        ...
	        0x0811: 'ZBHCI_CMD_ZCL_PRICE_PUBLISH_PRICE'
        }
