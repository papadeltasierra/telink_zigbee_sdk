...
// Note that additional (non-Telink) commands have bit 0x4000 set.
typedef enum{
	...
	ZBHCI_CMD_BDB_INFO_GET_KEY_REQ          = 0x4001,
	ZBHCI_CMD_BDB_INFO_SET_KEY_REQ          = 0x4002,
	ZBHCI_CMD_BDB_INFO_GET_KEY_RSP          = 0xC001,
