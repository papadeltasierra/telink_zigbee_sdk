...
typedef enum{
	...
	ZBHCI_CMD_BDB_GET_LINK_KEY_REQ          = 0x4001,
#if 0 // !!PDS:
	ZBHCI_CMD_BDB_SET_LINK_KEY_REQ          = 0x4002,
#endif
	ZBHCI_CMD_BDB_GET_MAC_ADDR_REQ          = 0x4003,
	ZBHCI_CMD_BDB_GET_LINK_KEY_RSP          = 0xC001,
	ZBHCI_CMD_BDB_GET_MAC_ADDR_RSP          = 0xC003,
	...
	ZBHCI_CMD_ZCL_PRICE_GET_CURRENT_PRICE	= 0x0710,
	ZBHCI_CMD_ZCL_PRICE_PUBLISH_PRICE   	= 0x8711,
}teHCI_MsgType;
